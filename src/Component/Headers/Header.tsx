...
function ColorSchemesExample() : JSX.Element {
    ...
    >
      <div className="container-fluid">
        <a className="navbar-brand " href="/">
          <img src="./kbmsoftweb.webp" alt="logo" width="150px" />
        </a>
        <button
          ...
          >
            ...
            <li className="nav-item">
              ...
              <li className="nav-item me-4 me-lg-0">
                  <a className="nav-link" href="mailto:contact@kbm-softweb.com">
                ...
                <li className="nav-item me-4 me-lg-0">
                  <a className="nav-link" href="https://wa.me/+21693545908">
